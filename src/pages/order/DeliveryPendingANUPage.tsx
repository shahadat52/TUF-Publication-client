...
import { useDeliveryPendingANUProductsQuery } from "../../redux/features/order/orderApi";
...
const DeliveryPendingProductsPage = () => {
...
`;
    ...
    const { data, isLoading } = useDeliveryPendingANUProductsQuery({ startDate: formattedStartDate, endDate: formattedEndDate });
    ...
    return (
        <div>
            ...
            <div ref={contentRef} className="p-4">
                ...
                <p className="text-center font-semibold text-xl uppercase mt-5">Delivery Pending Orders</p>
...
export default DeliveryPendingProductsPage;